  ...
  return (
    <div className='flex flex-col justify-center items-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            <h2 className='font-medium text-3xl max-w-lg mb-4'>Introducing AI powered text to image generator </h2>
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. 
                ...
                your text into eye-catching images with just a few clicks. Imagine it, describe it, 
                and watch it come to life instantly.</p>
                <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge AI will generate high-quality 
                    ...
                    AI technology, the creative possibilities are limitless!</p>
        </div>
      </div>
    </div>
  )
